    ...
    if (response.statusCode == 200) {
      ...
      grow_and_feding_data = list_data
          .map((e) => (e as List<dynamic>)
              ...
              .toList())
          .toList();
      list_data = jsonData['rain_salary_data'];
      rain_salary_data = list_data.map((e) => (e as num).toDouble()).toList();
      list_data = jsonData['temp_data'];
      temp_data = list_data.map((e) => (e as num).toDouble()).toList();
      list_data = jsonData['humidity_data'];
      humidity_data = list_data.map((e) => (e as num).toDouble()).toList();
    } else {
